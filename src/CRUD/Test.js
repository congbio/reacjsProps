...
class List extends Component {
  ...
  componentDidMount() {
    ...
    if (match) {
      ...
      axios({
      method: 'GET',
      url :`https://61bc131bd8542f0017824588.mockapi.io/a/arrayproducts/${id}`,
      data : null
     }).then(res =>{
      var data =res.data;
        this.setState({
    ...
    axios.get('https://61bc131bd8542f0017824588.mockapi.io/a/arrayproducts').then(res => {
  ...
  onSave = (event) => {
    ...
    if (this.state.id ===''){
      if(this.state.name !== '' && this.state.price!=='' && this.state.quantity !== '' && this.state.image!==''){
        axios({
          method:'POST',
          url :`https://61bc131bd8542f0017824588.mockapi.io/a/arrayproducts`,
          data: {
      ...
      axios({
        method:'PUT',
        url :`https://61bc131bd8542f0017824588.mockapi.io/a/arrayproducts/${this.state.id}`,
        data: {
          name: this.state.name,
            price: this.state.price,
      ...
      <div className="row">
          ...
          <form onSubmit={this.onSave}>
                ...
                <div className="form-group" id = "image-edit" style={{ display: "none" }}>
                    <label>Image</label>
                    <img src={this.state.avatar} alt="img" style={{ width: "100px" }}/>
                </div>
    ...
    <div className="col-8">
        <div className="row">
        {
            ...
            <div className="card col-4" style={{ width: "18rem" }}>
                <img className="card-img-top" src={product.avatar} alt="Card cap" />
